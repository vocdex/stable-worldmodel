...
#
# Usage:
#   sbatch scripts/cluster/plan_baseline/cube.sh                          # uses epoch_10
#   EPOCH=20 sbatch scripts/cluster/plan_baseline/cube.sh                 # override epoch
#   sbatch scripts/cluster/plan_baseline/cube.sh eval.num_eval=20         # extra hydra overrides
# -----------------------------------------------------------------------------
